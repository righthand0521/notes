...
<UNKNOWN> [UDP: [10.24.13.241]:56204->[192.168.0.1]:162]: Trap , iso.3.6.1.2.1.1.3.0 = Timeticks: (5724263) 15:54:02.63, iso.3.6.1.6.3.1.1.4.1.0 = OID: iso.3.6.1.6.3.1.1.5.1, iso.3.6.1.6.3.1.1.5.1 = STRING: "test coldStart"
# snmptrap -v2c -cpublic 192.168.0.1 "" 1.3.6.1.2.1.1.1.0 1.3.6.1.2.1.1.1.0 s ''
<UNKNOWN> [UDP: [10.24.13.241]:52601->[192.168.0.1]:162]: Trap , iso.3.6.1.2.1.1.3.0 = Timeticks: (5728845) 15:54:48.45, iso.3.6.1.6.3.1.1.4.1.0 = OID: iso.3.6.1.2.1.1.1.0, iso.3.6.1.2.1.1.1.0 = ""
# snmptrap -v1 -cpublic 192.168.0.1 "" localhost 3 0 ''
127.0.0.1: Link Up Trap (0) Uptime: 15:55:15.18
...
192.168.127.241: Enterprise Specific Trap (.17) Uptime: 15:56:28.86, iso.3.6.1.4.1.8072.2.3.2.1 = INTEGER: 123456
```
##### mib2c
```
